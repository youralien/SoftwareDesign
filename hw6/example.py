...
class CharactorSprite(pygame.sprite.Sprite):
	def __init__(self, group=None):
		...
		charactorSurf = pygame.image.load('images/player1.png')
...
class PygameView:
	...
	def ShowMap(self, gameMap):
		...
		squareRect = pygame.Rect( (-sidelength,spacing, sidelength,sidelength ) )

		column = 0
		for sector in gameMap.sectors:
			if column < 3:
				squareRect = squareRect.move( sidelength+spacing,0 )
			else:
				column = 0
				squareRect = squareRect.move( -((sidelength+spacing)*2), sidelength+spacing )
			column += 1
